    ...
    <div className="min-h-screen">
      {!configured && (
        <a href="/settings" className="block mb-6">
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 flex items-center justify-between hover:bg-yellow-500/20 transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-yellow-400 font-medium text-sm">Daraja credentials not configured</p>
                <p className="text-yellow-300/70 text-sm mt-0.5">Tap here to go to Settings and enter your credentials →</p>
              </div>
            </div>
          </div>
        </a>
